          ...
          >
            ...
            <ul className="flex flex-col md:flex-row justify-center items-center md:space-x-2">
              ...
              <li className="space-x-2 text-black">
                ...
                <a
                  target="blank"
                  href="https://www.linkedin.com/in/howida-fawaz-36627320a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                >
                ...
                <a target="blank" href="https://github.com/howidafawaz">
